...
class Customify_Builder_Footer_Item_Copyright {
	...
	function customize() {
		...
		$config = array(
			...
			array(
				...
				'render_callback' => $fn,
				'theme_supports'  => '',
				'default'         => __( 'Copyright &copy; {current_year} {site_title} - Powered by {theme_author}.', 'cszt' ),
				'title'           => __( 'Copyright Text', 'cszt' ),
				'description'     => __( 'Arbitrary HTML code or shortcode. Available tags: {current_year}, {site_title}, {theme_author}', 'cszt' ),
			),
			...
			array(
				...
				'type'       => 'typography',
				'section'    => $this->section,
				'title'      => __( 'Copyright Text Typography', 'cszt' ),
	...
	function render() {
		$tags = array(
			...
			'theme_author' => sprintf( '<span">%1$s</span>', 'cszt' ), // Brand name.
		);
